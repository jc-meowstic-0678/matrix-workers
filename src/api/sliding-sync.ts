...
import { OptimizedSlidingSyncHandler } from './sliding-sync/optimized-sync';
import { CachedSlidingSyncHandler } from './sliding-sync/caching-strategy';
import { D1ConnectionPool } from './sliding-sync/d1-pool';

const optimizedHandler = new OptimizedSlidingSyncHandler();
const cacheHandler = new CachedSlidingSyncHandler();
const pool = D1ConnectionPool.getInstance(c.env);
